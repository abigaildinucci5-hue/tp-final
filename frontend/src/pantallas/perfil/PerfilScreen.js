    ...
    <View style={ESTILOS_GLOBALES.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={estilos.menuContainer}>
          ...
          <TouchableOpacity 
            style={[estilos.menuItem, estilos.eliminarItem]} 
            onPress={() => setMostrarModalEliminar(true)}
          >
            <View style={estilos.menuIcono}>
              <MaterialCommunityIcons name="delete" size={24} color={COLORES.error} />
            </View>
            <Text style={[estilos.menuTexto, estilos.eliminarTexto]}>Eliminar Cuenta</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
        ...
        <View style={estilos.modalOverlay}>
          <View style={estilos.modalContainer}>
            ...
            <Text style={estilos.modalMessage}>
              ¿Estás seguro de que deseas eliminar tu cuenta? Esta acción es irreversible y se eliminarán todos tus datos, reservas e historial.
            </Text>
