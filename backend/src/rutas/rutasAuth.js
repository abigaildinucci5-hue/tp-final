...
/**
 * GET /api/auth/google
 * Iniciar flujo de autenticación con Google (WEB + MOBILE)
 * 
 * Query params:
...
router.get('/google', (req, res, next) => {
  ...
  if (req.session) {
    ...
    console.log(`📱 Guardado en session: oauthPlatform = ${platform}`);
  }
...
/**
 * GET /api/auth/github
 * Iniciar flujo de autenticación con GitHub (WEB + MOBILE)
 * 
 * Query params:
 *   - platform=mobile (opcional, para Expo/APK)
 * 
