  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: process.env.GOOGLE_CALLBACK_URL || 'https://tp-final-production-2d4c.up.railway.app/api/auth/google/callback',
  ...
  new GitHubStrategy(
    {
      ...
      callbackURL: process.env.GITHUB_CALLBACK_URL || 'https://tp-final-production-2d4c.up.railway.app/api/auth/github/callback',
      passReqToCallback: true,
